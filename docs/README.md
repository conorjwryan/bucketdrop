...
| [Sync](sync.md) | How config + credentials sync between macOS and iOS via iCloud Keychain, explicit refresh triggers, per-device settings, known limitations |
